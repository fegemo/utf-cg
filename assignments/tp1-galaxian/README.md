...
eventos usando WebGL. Para isso, vamos implementar um _video game_ simples.
...
- A tecla <kbd>esc</kbd> deve **pausar/continuar**;
- A tecla <kbd>r</kbd> deve **reiniciar** o jogo;

**Atenção:** uma mensagem de confirmação _in-game_ deve 
ser exibida para as ações de reiniciar o jogo.
...
e um vídeo (da entrega) equivalem a um total de **70%** da nota do trabalho.
...
- Relativas à **nave**:
  1. :star: **Vidas (5%)**: em vez de morrer na primeira colisão, 
     ...
     - Deve haver uma _head-up display_ (**HUD**) mostrando 
       a vida atual do jogador.
  1. :star: **Controle via mouse (4%)**: além do controle via teclado, torne
     possível jogar com o mouse.
- Outras funcionalidades:
  1. **TWGL.js (-15%)**: use a biblioteca para facilitar com o _boilerplate_
     do WebGL
  1. :star: **Sons (até 7%)**: colocar efeitos sonoros e música de fundo no seu jogo
  1. :star: **Tela cheia (4%)**: faça com que seja possível colocar em tela cheia
  ...
  1. :star: **Telas (até 10%)**: faça um jogo completo, ou seja, implemente telas de
     ...
     _game over_, etc.
  1. **Trailer (de 4 a 9%)**: em vez de um vídeo simples, faça um vídeo mais
...
5. Um link para um vídeo curto (30 a 60s) no YouTube mostrando seu jogo
   implementado. Faça um vídeo curto, não precisa ter um trabalhão!
